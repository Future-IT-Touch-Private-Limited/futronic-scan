...
public partial class all_analysts : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from analysts ORDER BY sr DESC";
    ...
    public void total_clicks_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from analysts";
