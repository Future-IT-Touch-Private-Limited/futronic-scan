...
public partial class pending_fingerprint_users : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from users where status_lh_lf_1='0' or status_lh_lf_2='0' or status_lh_lf_3='0' or status_lh_rf_1='0' or status_lh_rf_2='0' or status_lh_rf_3='0' or status_lh_mf_1='0' or status_lh_mf_2='0' or status_lh_mf_3='0' or status_lh_if_1='0' or status_lh_if_2='0' or status_lh_if_3='0' or status_lh_t_1='0' or status_lh_t_2='0' or status_lh_t_3='0' or status_rh_t_1='0' or status_rh_t_2='0' or status_rh_t_3='0' or status_rh_if_1='0' or status_rh_if_2='0' or status_rh_if_3='0' or status_rh_mf_1='0' or status_rh_mf_2='0' or status_rh_mf_3='0' or status_rh_rf_1='0' or status_rh_rf_2='0' or status_rh_rf_3='0' or status_rh_lf_1='0' or status_rh_lf_2='0' or status_rh_lf_3='0' ORDER BY sr DESC";
    ...
    public void total_clicks_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from users where  status_lh_lf_1='0' or status_lh_lf_2='0' or status_lh_lf_3='0' or status_lh_rf_1='0' or status_lh_rf_2='0' or status_lh_rf_3='0' or status_lh_mf_1='0' or status_lh_mf_2='0' or status_lh_mf_3='0' or status_lh_if_1='0' or status_lh_if_2='0' or status_lh_if_3='0' or status_lh_t_1='0' or status_lh_t_2='0' or status_lh_t_3='0' or status_rh_t_1='0' or status_rh_t_2='0' or status_rh_t_3='0' or status_rh_if_1='0' or status_rh_if_2='0' or status_rh_if_3='0' or status_rh_mf_1='0' or status_rh_mf_2='0' or status_rh_mf_3='0' or status_rh_rf_1='0' or status_rh_rf_2='0' or status_rh_rf_3='0' or status_rh_lf_1='0' or status_rh_lf_2='0' or status_rh_lf_3='0'";
