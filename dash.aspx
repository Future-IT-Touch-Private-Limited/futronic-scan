<%@ Page Title="" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="dash.aspx.cs" Inherits="dash" %>
                        ...
                        <div class="card all-properties">
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <a href="listing.html" class="arrow-animated">See all properties
                            ...
                            <div class="card-body calculations">
                                ...
                                <div class="d-flex">
                                    <a href="agent-invoice.html" class="label label-light color-4">
                                        ...
                                        Payments Receive</a>
                                    <a href="agent-invoice.html" class="arrow-animated">View all
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span>
                                    <span class="font-success">Coming soon
                                                </span>
                                </span>
                                <h4>10,000</h4>
                            ...
                            <table class="table table-bordernone">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="font-danger">10</h6>
                                            <span>Open</span>
                                        </td>
                                        <td>
                                            <h6 class="font-warning">3</h6>
                                            <span>Escaleted</span>
                                        </td>
                                        <td>
                                            <h6 class="font-success">126</h6>
                                            <span>Completed</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="font-danger">8</h6>
                                            <span>Open</span>
                                        </td>
                                        <td>
                                            <h6 class="font-warning">20</h6>
                                            <span>Escaleted</span>
                                        </td>
                                        <td>
                                            <h6 class="font-success">154</h6>
                                            <span>Completed</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="font-danger">5</h6>
                                            <span>Open</span>
                                        </td>
                                        <td>
                                            <h6 class="font-warning">18</h6>
                                            <span>Escaleted</span>
                                        </td>
                                        <td>
                                            <h6 class="font-success">79</h6>
                                            <span>Completed</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="font-danger">15</h6>
                                            <span>Open</span>
                                        </td>
                                        <td>
                                            <h6 class="font-warning">7</h6>
                                            <span>Escaleted</span>
                                        </td>
                                        <td>
                                            <h6 class="font-success">145</h6>
                                            <span>Completed</span>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div class="col-xl-5 xl-6">
                <div class="card expiring-card">
                    <div class="card-header">
                        <div class="d-flex">
                            <h5>Sold out</h5>
                            <a href="apartment.html" class="arrow-animated">See Details
                        ...
                        <div class="legend-exiring">
                            <ul>
                                <li>
                                    ...
                                    <span class="light-font">> 20 Days</span>
                                </li>
                                <li>
                                    <div class="d-flex">
                                    ...
                                    <span class="light-font">21 - 40 Days</span>
                                </li>
                                <li>
                                    <div class="d-flex">
                                    ...
                                    <span class="light-font">41 - 80 Days</span>
                                </li>
                            </ul>
                        </div>
                    </div>
