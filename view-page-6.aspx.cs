...
public partial class view_page_6 : System.Web.UI.Page
{
    ...
    public void fillPercentage()
    {
        ...
        try
        {
            visual_percent.Text = (float_r4_percent+float_l4_percent).ToString()+"%";
            auditory_percent.Text = (float_r5_percent + float_l5_percent).ToString() + "%";
            kinesthetic_percent.Text = (float_r3_percent + float_l3_percent).ToString() + "%";
        }
        catch(Exception ex)
        { }
    }
