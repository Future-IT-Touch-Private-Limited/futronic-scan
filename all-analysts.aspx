<%@ Page Title="All Analysts" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="all-analysts.aspx.cs" Inherits="all_analysts" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">All Analysts</li>
                    </ol>
                    <!-- Breadcrumb end -->
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Total: <asp:Label ID="total_analysts_lbl" Font-Bold="true" runat="server" Text="0"></asp:Label></h5>
                    </div>
                                ...
                                <table class="jsgrid-table table table-hover table-bordered">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="jsgrid-row">
                                                <td>
                                                    <asp:Label ID="analyst_username_3des" runat="server" Text='<%# Eval("analyst_username_3des") %>'></asp:Label></td>
                                                <td><%# Eval("analyst_name") %></td>
                                                <td><%# Eval("analyst_city") %></td>
                                                <td><%# Eval("analyst_state") %></td>
                                                <td><%# Eval("analyst_contact_no") %></td>
                                                <td><%# Eval("analyst_account_date") %></td>
                                                <td><span><%# Eval("analyst_account_status") %></span></td>
                                                <td><a href='edit-analyst.aspx?sr=<%# Eval("sr") %>'>View/Edit</a></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
