<%@ Page Title="Pending fingerprint of user's" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="pending-fingerprint-users.aspx.cs" Inherits="pending_fingerprint_users" %>
