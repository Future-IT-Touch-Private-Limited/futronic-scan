<%@ Page Title="Retake Required" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="retake-users.aspx.cs" Inherits="retake_users" %>
                            ...
                            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                <table class="jsgrid-table table table-hover table-bordered">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="jsgrid-row">
                                                <td><asp:Label ID="userid_plain" runat="server" Text='<%# Eval("userid_plain") %>'></asp:Label></td>
